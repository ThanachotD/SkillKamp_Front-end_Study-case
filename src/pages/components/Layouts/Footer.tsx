...
export default function Footer() {
    ...
    return (
        <>
      <div className=" bg-[#282828] w-screen px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <p className="mt-8 text-base leading-6 text-center text-white tracking-widest ">
       ...
       <button className='bg-[#D2461C] p-2 px-6 text-white tracking-normal'> Subscribe Now</button> 
        ...
        <p className="mt-8 text-base leading-6 text-center text-white">
            © 2023 by happy kids. Powered and secured by Thanachot
        </p>
            </div>
        </>
    );
